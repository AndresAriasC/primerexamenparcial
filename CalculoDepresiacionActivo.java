...
public class CalculoDepresiacionActivo {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				for (int i = 0; i < vidaUtil; i++) {
					depAnual = (costoActivo-valorDesecho)/aukm;
					 ...
					 System.out.println("Depreciacion anual "+result);
				}
				System.out.println("----------------------------");
			...
			case 3:
				double cuotaAmor;
				System.out.println(name + " Ha elegido Metodo de reduccion de saldos");
				System.out.print("Escriba el costo del activo: ");
				costoActivo = en.nextDouble();
				System.out.print("Escriba el valor de desecho: ");
				valorDesecho = en.nextDouble();
				...
				cuotaAmor = costoActivo/vidaUtil;
				cuotaAmor = cuotaAmor/100;
				cuotaAmor = cuotaAmor*2;
				
				System.out.println("La depreciacion anual es: " + cuotaAmor);
				System.out.println("Es el metodo menos trabajado de mi parte, perdon.");
			...
			case 4:
				...
				for (int i = 0; i < vidaUtil; i++) {
					do {
						depAnual = (costoActivo-valorDesecho)*((vidaUtil-i)/denominador);
						System.out.println("Depreciacion: "+(i+1)+ ") " + depAnual);
						break;
					}while(vidaUtil < 0);
